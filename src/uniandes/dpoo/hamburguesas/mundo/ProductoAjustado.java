...
public class ProductoAjustado implements Producto
{
    ...
    public int getPrecio() {
        int precioTotal = productoBase.getPrecio(); // Precio base
        for (Ingrediente ing : agregados) {
            precioTotal += ing.getCostoAdicional(); // Sumar el costo de los ingredientes adicionales
        }
        return precioTotal; // Retornar el precio total
    }
    /**
    ...
    public String generarTextoFactura( )
    {
        ...
        sb.append(productoBase.toString()).append("\n");
        for( Ingrediente ing : agregados )
        {
